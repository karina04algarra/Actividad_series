...
const obj_episodios = new Episodio("Temporada 1", "Resumen de la temporada", 120);
...
const obj_directora_karina = new Director("Karina", "kari.jpg", "Eres la mejor en todo", []);
...
const obj_juego_de_tronos = new Serie("prueba.jpg", "Juego de tronos", obj_categoria, obj_directora_karina, obj_actores, obj_episodios, obj_plataforma);
